;
; Woz' SWEET16 interpreter, adjusted for the Commander X16.
...
; Compiler:             CC65
; Build using: cl65 --start-addr 0x0600 -t cx16 sweetX16.s -C cx16-asm.cfg -o SWEETX16.PRG
;
; SIZE: with the Save/Restore routines, this is 438 bytes long.
; LOCATION: 0x0600–0x07BF (user space, above ADSR manager at 0x0400)
;
; ENTRY POINT is $0600 or $0603. (If you don't care about saving the registers, then SYS $0603.)
;
;
;  X16's r0-r15 ABI
;
...
LD:     LDA  R0L,X
BK:                         ; BK entry point (for opcode $0A)
        STA  R0L
